...
from .utils import (
    ...
    extractdurationsecondsfromlrc, optionalimportfrom, searchdictbykey, cursorpickintable, obtainhostname, hostmatchessuffix, smarttrunctable, colorize, dedupkeeporder, hashablesth, get_default_work_dir,
    # lambda functions
    cleanlrc,
)